"""Analyzer tests: linear no-escape / no-launder / seal-into-container: container
laundering, borrowed-no-escape, into-container-reject, and
container-of-linear seal.
