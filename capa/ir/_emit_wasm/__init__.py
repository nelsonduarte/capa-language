...
# Capability methods whose canonical-ABI return type lowers to more
# than one flat value, forcing an indirect return through a
...
# ``_emit_cap_indirect_materialise`` (kept off the hot path so each
# return shape can evolve independently).
