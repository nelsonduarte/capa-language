...
def build_path_arg_surface(module: A.Module) -> dict[str, Any]:
    ...
    return {
        ...
        "note": (
            ...
            "RESIDUAL (the one honest gap): a closure carried by a value the "
            "AST-level pass cannot statically tie back to a lambda -- "
            "re-extracted from a runtime container by key, or threaded "
            "through an opaque computed value -- may be under-reported. This "
