...
def build_path_arg_surface(module: A.Module) -> dict[str, Any]:
    ...
    return {
        ...
        "note": (
            ...
            "Scope is also covered: a named closure bound inside ANOTHER "
            "lambda's body is followed, so the analysis does not miss a sink "
            "in a nested closure sub-scope. RESIDUAL (the one honest gap, "
